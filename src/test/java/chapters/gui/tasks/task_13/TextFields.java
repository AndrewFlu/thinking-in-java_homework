package chapters.gui.tasks.task_13;
...
/**
 * Показывает дополнительные возможности текстовых полей.
...
public class TextFields extends JFrame {
    ...
    private class T1 implements DocumentListener {
        @Override
    ...
    public static void main(String[] args) {
        SwingConsole.run(new TextFields(), 375, 400);
    }
}
